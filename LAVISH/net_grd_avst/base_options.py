...
class BaseOptions():
	...
	def initialize(self):
		self.parser.add_argument(
			"--audio_dir", type=str, default='./AVQA/data/feats/vggish', help="audio dir")
		self.parser.add_argument(
		    "--video_dir", type=str, default='./AVQA/data/frames', help="video dir")
		self.parser.add_argument(
			"--video_res14x14_dir", type=str, default='./AVQA/data/feats/res18_14x14', help="res14x14 dir")
		
		self.parser.add_argument(
			"--label_train", type=str, default="./AVQA/data/json/avqa-train.json", help="train csv file")
		self.parser.add_argument(
			"--label_val", type=str, default="./AVQA/data/json/avqa-val.json", help="val csv file")
		self.parser.add_argument(
			"--label_test", type=str, default="./AVQA/data/json/avqa-test.json", help="test csv file")
		self.parser.add_argument(
		...
		self.parser.add_argument(
			"--model_save_dir", type=str, default='./AVQA/net_grd_avst/avst_models/', help="model save dir")
		self.parser.add_argument(
