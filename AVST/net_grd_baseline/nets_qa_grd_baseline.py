...
import sys
sys.path.append('./AVST/net_grd_avst')
import numpy as np
...
class QstEncoder(nn.Module):
    ...
    def forward(self, question):
        ...
        # Debug print
        # print(f'qst_feature: {qst_feature.shape}')
        return qst_feature
...
class AVQA_Fusion_Net(nn.Module):
    ...
    def __init__(self):
        ...
        # question
        self.question_encoder = QstEncoder(237, 512, 512, 1, 512) # 237 stands for ques_vocab length

        self.tanh = nn.Tanh()
        self.dropout = nn.Dropout(0.5)
        self.fc_ans = nn.Linear(512, 146) # 146 stands for ans_vocab length
    ...
    def forward(self, audio,visual_posi,visual_nega, question):    
        ...
        # print(f'posi_visual_feat: {posi_visual_feat.shape}')
        ...
        # print(f'visual_feat_grd: {visual_feat_grd.shape}')
        ...
        # print(f'visual_feat_att: {visual_feat_att.shape}')
        ...
        # print(f'visual_feat_att after norm: {visual_feat_att.shape}')
