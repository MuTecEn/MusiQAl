...
import sys 
sys.path.append("./AVST/")   # path to your project root
...
writer = SummaryWriter('./AVST/runs/grounding_gen/'+TIMESTAMP)
...
def main():
    ...
    parser.add_argument(
        '--log-interval', type=int, default=300, metavar='N', help='how many batches to wait before logging training status')
    parser.add_argument(
