...
if __name__ == '__main__':
    ...
    parser.add_argument("--output_dir", dest='output_dir', type=str, default='./AVST/data/feats/res18_14x14/', 
                        help='directory to store features')
    parser.add_argument("--n_frame_steps", dest='n_frame_steps', type=int, default=480,
                        help='how many frames to sampler per video')
    parser.add_argument("--video_path", dest='video_path', type=str, default='./AVST/data/frames', 
