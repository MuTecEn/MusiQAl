...
checkpoint_path = './AVST/pretrained/vggish_model.ckpt'
pca_params_path = './AVST/pretrained/vggish_pca_params.npz'
# num_secs = 60 # length of the audio sequence. Videos in our dataset are all 10s long.
freq = 1000
sr = 44100


audio_dir = "./AVST/data/audio/" # .wav audio files
save_dir = "./AVST/data/feats/vggish/"
